        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            ...
            {token && (
              <div className="hidden md:flex space-x-4 ml-8">
                ...
                <Link to="/cart" className="flex items-center text-gray-700 hover:text-indigo-600 px-3 py-2 rounded-md text-sm font-medium">
          ...
          {!token ? (
            <div className="hidden md:flex items-center space-x-4">
              <Link to="/signup" className="text-indigo-600 hover:bg-indigo-50 px-4 py-2 rounded-md text-sm font-medium">Register</Link>
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                <span className="absolute -top-2 -right-2 text-white text-xs bg-red-600 rounded-full w-5 h-5 flex items-center justify-center">
                  {totalQty}
                </span>
              </div>
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link to="/services" className="block text-gray-700 hover:text-indigo-600 px-3 py-2 rounded-md text-base font-medium">Services</Link>
            ...
            {!token ? (
              <>
                <Link to="/signup" className="block text-indigo-600 hover:bg-indigo-50 px-3 py-2 rounded-md text-base font-medium">Register</Link>
                <Link to="/login" className="block bg-indigo-600 text-white px-3 py-2 rounded-md text-base font-medium hover:bg-indigo-700">Login</Link>
              </>
            ) : (
              <button onClick={logout} className="w-full text-left text-indigo-600 hover:bg-indigo-50 px-3 py-2 rounded-md text-base font-medium">
                Logout
              </button>
            )}
          </div>
